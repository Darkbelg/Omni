...
You mark what is Gameplay and NOT gameplay.
...
- Loading screens.
- Menu screens.
- No gameplay on the screen.
- Setting screens.
- BRB screens.
- Stream starting soon screen.
- Spotlight on the streamers face in the center of the screen.
- Reading sponsors or donations from twitch viewers.
- Thanking a person for subscribing.
- Thanking a person for resubscribing.
- Windows desktop.
- Talking to chat.
- A guy with his hands in his hair and a stripe through a camera indicating a disconnect and no audio of Mr Sark.

## Answer Format
You answer should be like a csv row with commas separating the columns.
The first column describes the video clip.
The second column is the reason you are going to mark this as Gameplay or NOT gameplay.
The third column should contain if it is Gameplay or NOT gameplay.
